...
<body id="main_body">
    ...
    <div class="container row justify-content-center col-12">
        <div class="allusers row col-12 justify-content-center">
            <h1 class='col-6 row justify-content-center'> <strong class="text-light">AddProducts</strong></h1>
        </div>
        <div class="col-8">
            <form id="" class="addproduct white form" method="POST" action="" enctype="multipart/form-data">
